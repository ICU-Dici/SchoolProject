...
let HighSchoolsRatingInitState = {
    ...
    OtherSpec:[
        ...
        {title:'Системное программирование и прикладная математика', id:'09.03.01', Subjects:{first:{kod:"РФИМ", trans:'Русский Язык, Физика, Информатика, Математика'}, marks:'385'}},
        {title:'Техническая физика', id:'16.03.01', Subjects:{first:{kod:"РИМ", trans:'Русский Язык, Информатика, Математика'}, second:{kod:"РФМ", trans:'Русский Язык, Физика, Математика'}, marks:'293'}},
