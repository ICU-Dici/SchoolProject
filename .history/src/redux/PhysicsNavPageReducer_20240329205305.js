...
let PhyNavPageInitState = {
    ...
    ParentsCases:[
        ...
        {Name:'Поступление в ВУЗы', index:4, childContent:[{name:"Калькулятор ВУЗа"},{name:"Перевод баллов ЕГЭ", PathTo:'/Physics/PointsTransfer', BackgroundColor:'white'},{name:"Рейтинг ВУЗов"},{name:"Цель работы"}], MainInfo: ['Поступление в ВУЗ', 'Заведомо спланированные действия чаще протекают по плану, ведь он есть'], img:'https://www.m24.ru/b/d/nBkSUhL2hFMgkcm0JL6BrNOp2Z3z8Zj21iDEh_fH_nKUPXuaDyXTjHou4MVO6BCVoZKf9GqVe5Q_CPawk214LyWK9G1N5ho=tb6yLu1kqkK2a9mz0Bg5Nw.jpg'},
