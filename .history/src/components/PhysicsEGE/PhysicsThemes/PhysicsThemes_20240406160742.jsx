        ...
        return (
            <div>
                { props.isCurrentPageNav === 1 ?
                 ...
                 <div onClick={() => {props.SetCurrentTheme()}} className={s.CMThemeWrap}><NavLink className={s.CMTheme}>{props.Themes[0].name}</NavLink></div>
                 <div onClick={() => {props.SetCurrentTheme()}} className={s.EThemeWrap}><NavLink className={s.ETheme}>{props.Themes[1].name}</NavLink></div>
                 <div onClick={() => {props.SetCurrentTheme()}} className={s.NPThemeWrap}><NavLink className={s.NPTheme}>{props.Themes[2].name}</NavLink></div>
                 <div onClick={() => {props.SetCurrentTheme()}} className={s.MKTThemeWrap}><NavLink className={s.MKTTheme}>{props.Themes[3].name}</NavLink></div>
                 <div onClick={() => {props.SetCurrentTheme()}} className={s.OThemeWrap}><NavLink className={s.OTheme}>{props.Themes[4].name}</NavLink></div>
                 <div onClick={() => {props.SetCurrentTheme()}} className={s.TORThemeWrap}><NavLink className={s.TORTheme}>{props.Themes[5].name}</NavLink></div>
                 </div>
                   :
                   
                   <div className={s.CurrentTheme}>
                   <div className={s.CurrentThemeTitle}>ELECTRICITY</div>
                   <div className={s.CurrentContent}>
                       <div className={s.CurrentContentContentInfo}></div>
                       <div className={s.CurrentContentContent}></div>
                   </div>
                     </div>
                :
