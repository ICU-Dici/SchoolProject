...
const PhysicsThemes= () => {
        return (
            <div>
                ...
                <div><NavLink className={s.MKTTheme}>molecular kinetic theory</NavLink></div>
                <div><NavLink className={s.OTheme}>Optics</NavLink></div>
                <div><NavLink className={s.TORTheme}>theory of relativity</NavLink></div>
            </div>
        )
}
