...
const PhysicsThemes= (props) => {
        return (
            <div>
                ...
                <div className={s.NOCMThemeWrap}><NavLink className={s.NOCMTheme}>classical mechanics</NavLink></div>
                <div className={s.NOEThemeWrap}><NavLink className={s.NOETheme}>Electrodynamics</NavLink></div>
                <div onClick={props.ChangeCurrentPageToNav} className={s.NONPThemeWrap}><NavLink className={s.NONPTheme}>nuclear physics</NavLink></div>
