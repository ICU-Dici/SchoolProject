...
const PhysicsThemes= (props) => {
    debugger
        return (
            <div>
                { props.isCurrentPageNav === true ?
                 <div>
                <div className={s.CenterSlog}>PHYSICS</div>
                <div onClick={props.ChangeCurrentPageToOther} className={s.CMThemeWrap}><NavLink  onClick={props.ChangeCurrentPageToOther}  className={s.CMTheme}>classical mechanics</NavLink></div>
                ...
                <div onClick={props.ChangeCurrentPageToNav} className={s.NOCMThemeWrap}><NavLink  onClick={props.ChangeCurrentPageToOther}  className={s.NOCMTheme}>classical mechanics</NavLink></div>
