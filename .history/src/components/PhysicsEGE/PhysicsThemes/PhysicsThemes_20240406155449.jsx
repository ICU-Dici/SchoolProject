        ...
        return (
            <div>
                { props.isCurrentPageNav === 1 ?
                 ...
                 <div onClick={props.ChangeCurrentPageToOther} className={s.CMThemeWrap}><NavLink className={s.CMTheme}>{props.Themes[0].name}</NavLink></div>
                 <div className={s.EThemeWrap}><NavLink className={s.ETheme}>{props.Themes[0].name}</NavLink></div>
                 <div className={s.NPThemeWrap}><NavLink className={s.NPTheme}>{props.Themes[0].name}</NavLink></div>
                 <div className={s.MKTThemeWrap}><NavLink className={s.MKTTheme}>{props.Themes[0].name}</NavLink></div>
                 <div className={s.OThemeWrap}><NavLink className={s.OTheme}>{props.Themes[0].name}</NavLink></div>
                 <div className={s.TORThemeWrap}><NavLink className={s.TORTheme}>{props.Themes[0].name}</NavLink></div>
                 </div>
                   :
