        ...
        return (
            <div>
                { props.isCurrentPageNav === 1 ?
                 ...
                 <div className={s.EThemeWrap}><NavLink className={s.ETheme}>{props.Themes[1].name}</NavLink></div>
                 <div className={s.NPThemeWrap}><NavLink className={s.NPTheme}>{props.Themes[2].name}</NavLink></div>
                 <div className={s.MKTThemeWrap}><NavLink className={s.MKTTheme}>{props.Themes[3].name}</NavLink></div>
                 <div className={s.OThemeWrap}><NavLink className={s.OTheme}>{props.Themes[4].name}</NavLink></div>
                 <div className={s.TORThemeWrap}><NavLink className={s.TORTheme}>{props.Themes[5].name}</NavLink></div>
                 </div>
                   :
