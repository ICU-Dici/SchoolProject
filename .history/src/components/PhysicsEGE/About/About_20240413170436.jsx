                ...
                <div className={s.Navigation}>
                    <div className={s.NavigationUL}>
                        <div><div className={s.Name}>Нерешенные проблемы</div>
                            <div className={s.shortInfo}>здесь вы вкратце узнаете в чем заключается проблема так называемой "стрелы времени", о теоретических проблемах и неизученных областых эксперементальной физике</div>
                        </div>
