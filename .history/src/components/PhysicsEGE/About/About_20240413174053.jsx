            ...
            <div className={s.firstSlide}>
                ...
                <div className={s.Navigation}>
                    <div className={s.NavigationUL}>
                        ...
                        <div className={s.shortInfo2}>Использование зананий физики в соврменном мире и промышленном прозводстве, сферы промышленности, которые производят продукт на основе физических законов</div>
                        </div>
                        ...
                        <div className={s.shortInfo5}>Современные ученые, состоящие в научном сообществе</div>
                        </div>
                    </div>
                </div>
            </div>
