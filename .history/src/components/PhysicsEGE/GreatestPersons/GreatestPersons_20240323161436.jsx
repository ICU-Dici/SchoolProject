    ...
    return (
        <div>
            ...
            <div className={s.ShortInfo}>
                ...
                <div>
                    <div className={s.PartOfShortIngo}>{props.CurrentChoosenScientist.MainInfo.first}</div>
                    <a href="" className={s.href}>{props.CurrentChoosenScientist.MainInfo.second}</a>
                    <div className={s.PartOfShortIngo}>{props.CurrentChoosenScientist.MainInfo.third}</div>
                    <a href="" className={s.href}>{props.CurrentChoosenScientist.MainInfo.fourth}</a>
                    <div className={s.PartOfShortIngo}>{props.CurrentChoosenScientist.MainInfo.fifth}</div>
                    </div>
            </div>
            </div>
            </div>
