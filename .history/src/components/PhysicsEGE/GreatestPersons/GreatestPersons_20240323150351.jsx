...
const GreatestPersons = (props) => {
    return (
        <div>
            ...
            <div className={s.closeBurgMenu}><span className={s.closeBurgMenuText}>close</span> <span className={s.closeBurgMenuSymbol}>&#10006;</span></div>
            ...
            <div className={s.closeBurgMenu} onClick={props.CloseScientistsWindow} ><span className={s.closeBurgMenuText}>&#10006;</span> <span className={s.closeBurgMenuSymbol}>&#10006;</span></div>
                <img className={s.ScientistWindowPhoto} src={props.CurrentChoosenScientist.photo}/>
            { props.CurrentChoosenScientist.MainInfo}
            </div>
            </div>
