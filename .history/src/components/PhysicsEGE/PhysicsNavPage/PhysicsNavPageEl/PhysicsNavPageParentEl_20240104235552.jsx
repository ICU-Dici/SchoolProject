    ...
    return(
        <div>
            ...
            {props.selectedCase === props.index & props.phoneScreen===true ? <div>
                    ...
                    <div className={props.ParentsCases[props.index-1].childContent === props.ChildCases ? s.ChildrenElements :s.ChildrenElementsHidden}>
                    ...
                    {props.ChildCases.map(Childitem =>
                        {return <PhysicsNavPageChildEl content={Childitem.name} PathTo={Childitem.PathTo} CloseOnClick={props.CloseOnClick}/>}
                    )}
                </div>
            </div>
                : <div></div>
