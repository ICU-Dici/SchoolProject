        ...
        <div>
            ...
            {props.selectedCase === props.index & props.phoneScreen === true ? <div>
                ...
                <div className={s.ChildrenElements}>
                    ...
                    {props.ChildCases.map(Childitem => { return <PhysicsNavPageChildEl selectedCase={props.selectedCase} content={Childitem.name} PathTo={Childitem.PathTo} CloseOnClick={props.CloseOnClick} /> }
                    )}
                </div>
            </div>
                : 
