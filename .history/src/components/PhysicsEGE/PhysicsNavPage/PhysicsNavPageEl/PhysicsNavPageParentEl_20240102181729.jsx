...
const PhysicsNavPageParentEl = (props) => {
    return(
        <div>
            ...
            <div className={props.isBurgerMenuOpened ? s.burgerParentEl: s.burgerParentElHidden} onClick={() => {props.ChooseCaseAc(props.index, props.ChildCases, props.MainInfo, CurrentBackgroudImg)}}>{props.Name}</div> : 
