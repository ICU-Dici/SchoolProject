        ...
        <div className={s.AheadWrapper}>
            ...
            <div className={s.Wrapper}>
                ...
                <div className={s.Ratings}>
                    <div className={s.CountryRating}><img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQuRAUhA6zoWw0Hafr-PcQFHqBxndZF6BqgSRtTUBf99vPW2OIHgAFz9dWt3DGzYKQL_VA&usqp=CAU'/> МЕСТЕ В РОССИИ</div>
