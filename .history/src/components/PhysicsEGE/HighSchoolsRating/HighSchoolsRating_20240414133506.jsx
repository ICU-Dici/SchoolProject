        ...
        <div className={s.AheadWrapper}>
            ...
            <div className={s.Wrapper}>
                <div className={s.Specialities}>
                    ...
                    <div>
                        <div className={s.leadingSpec}><div>Компьютерные технологии и вычислительная техника 09.03.01</div><div>ЕГЭ: МРФ/МРИ=303 балла</div></div>
                        <div className={s.NotLeadingSpec}>
                            <div><div>Программная инженерия и компьютерные технологии</div><div>ЕГЭ:МРИ=293 балла</div></div>
                            <div><div>Системное программирование и прикладная математика</div><div>ЕГЭ:МРИФ=293 балла</div></div>
                            <div><div>Программная инженерия и компьютерные технологии</div><div>ЕГЭ:МРИ=293 балла</div></div>
                            <div><div>Программная инженерия и компьютерные технологии</div><div>ЕГЭ:МРИ=293 балла</div></div>
                            <div><div>Программная инженерия и компьютерные технологии</div><div>ЕГЭ:МРИ=293 балла</div></div>
                        </div>
