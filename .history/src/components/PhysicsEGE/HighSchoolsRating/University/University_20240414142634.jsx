        ...
        <div>
            <div className={s.Wrapper}>
                <div className={s.Specialities}>
                    ...
                    <div>
                        <div className={s.leadingSpec}><div>{props.bestSpec.title}</div><div>Проходные Баллы:<div title={props.bestSpec.Subjects.first.trans}>{props.bestSpec.Subjects.first.kod}</div>/<div title={props.bestSpec.Subjects.second.trans}>{props.bestSpec.Subjects.second.kod}</div></div></div>
                        <div className={s.NotLeadingSpec}>
                            <div className={s.spec}><div title="XEQ">Программная инженерия и компьютерные технологии</div><div>ЕГЭ:МРИ=293</div></div>
                            <div className={s.spec}><div>Системное программирование и прикладная математика</div><div>ЕГЭ:МРИФ=385</div></div>
