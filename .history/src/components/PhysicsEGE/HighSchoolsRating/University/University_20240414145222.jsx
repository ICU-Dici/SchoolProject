        ...
        <div>
            <div className={s.Wrapper}>
                ...
                <div className={s.MainCenterInfo}>
                    <div><img className={s.LogoUniversity} src={props.logo} /></div>
                ...
                <div className={s.Ratings}>
                    <div className={s.CountryRating}><img className={s.RatingIMG} src='https://i.pinimg.com/564x/b7/dd/f8/b7ddf86be87e37fd7d7ed9fcd7c5b012.jpg'/> <div className={s.Number}>{props.RussianRating}</div> <div className={s.text}>Место В РОССИИ</div></div>
                    <div className={s.GlobalRating}><img className={s.RatingIMG} src='https://i.pinimg.com/564x/b7/dd/f8/b7ddf86be87e37fd7d7ed9fcd7c5b012.jpg'/> <div className={s.Number}>{props.GlobalRating}</div> <div className={s.text}>МЕСТо В СТРАНЕ</div></div>
                </div>
            </div>
        </div>
    )
