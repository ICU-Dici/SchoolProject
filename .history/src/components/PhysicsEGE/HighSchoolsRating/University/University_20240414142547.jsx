        ...
        <div>
            <div className={s.Wrapper}>
                <div className={s.Specialities}>
                    ...
                    <div>
                        <div className={s.leadingSpec}><div>{props.bestSpec.title}</div><div>Проходные Баллы:<div title={props.bestSpec.Subjects.first.trans}>{props.bestSpec.Subjects.first.kod}</div>/{props.bestSpec.Subjects.second.kod}</div></div>
