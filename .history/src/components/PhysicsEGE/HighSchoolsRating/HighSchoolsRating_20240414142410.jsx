        ...
        <div className={s.AheadWrapper}>
            ...
            <div className={s.Wrapper}>
                <div className={s.Specialities}>
                    ...
                    <div>
                        <div className={s.leadingSpec}><div></div><div>ЕГЭ: МРФ/МРИ=303</div></div>
                        <div className={s.NotLeadingSpec}>
                            <div className={s.spec}><div title="ХУЙ">Программная инженерия и компьютерные технологии</div><div>ЕГЭ:МРИ=293</div></div>
