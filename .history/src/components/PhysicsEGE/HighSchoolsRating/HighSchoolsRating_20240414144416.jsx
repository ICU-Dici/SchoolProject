        ...
        <div className={s.AheadWrapper}>
            {props.Universities.map(el => {
                return (<div>
                    ...
                    <University name={el.name} transcript={el.transcript} logo={el.logo} backgroundIMGStyle={el.backgroundIMGStyle} RussianRate={el.RussianRate} GlobalRate={el.GlobalRate} bestSpec={el.bestSpec}/>
                </div>)
            })}
        </div>
    )
