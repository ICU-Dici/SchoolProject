        ...
        <div>
            <div className={s.HeaderBurgerMenu}>
                ...
                <div className={s.ParentsElements}>
                    ...
                    <PhysicsNavPageEl isBurgerMenuOpened={props.isBurgerMenuOpened}Content={'Общеобразовательные материалы'} selectedCase= {props.selectedCase} ChooseCaseAc={props.ChooseCaseAc} index={2}/>
                    ...
                    <PhysicsNavPageEl isBurgerMenuOpened={props.isBurgerMenuOpened}Content={'Рекомендации по подготовке'} selectedCase= {props.selectedCase} ChooseCaseAc={props.ChooseCaseAc} index={4}/>
                    <PhysicsNavPageEl isBurgerMenuOpened={props.isBurgerMenuOpened}Content={'Новости'} selectedCase= {props.selectedCase} ChooseCaseAc={props.ChooseCaseAc} index={5}/>
