        ...
        <div className={s.AheadWrapper}>
            <div className={s.NavBlocksWrapper}>
                <div className={s.PhysicsPath} >
                    <div className={s.PhysicsLink} onClick={() => {props.SelectBlockAc('/Physics/*')}}><PhyBlockStructureContainer index={'/Physics/*'} blockName={'Физика'} blockInfo={'10-11 Класс'}/></div>
                    <div className={s.PhysicsLink} onClick={() => {props.SelectBlockAc('/Physics/PointsTransfer')}}><PhyBlockStructureContainer index={'/Physics/PointsTransfer'} blockName={'Физика'} blockInfo={'7-9 Класс'}/></div>
                </div>
                <div>
