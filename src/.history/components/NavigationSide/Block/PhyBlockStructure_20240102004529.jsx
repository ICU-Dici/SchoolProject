    ...
    return (
        <div className={s.Wrapper}>            
            <div className={s.Block}>
                { props.typeOfBloc===1 ? 
                <div className={ props.selected === props.index ? s.MainBodyBlockActive1 : s.MainBodyBlock1}>
                <div>{props.blockName}</div>
                <div>{props.blockInfo}</div>
            </div> 
            : <div className={ props.selected === props.index ? s.MainBodyBlockActive2 : s.MainBodyBlock2}>
                <div>{props.blockName}</div>
                <div>{props.blockInfo}</div>
                </div> 
